...
<h2 className="container-title" style={{ marginBottom: '10px' }}>Why Choose Our Platform</h2>
<h4 className="h4" style={{ marginBottom: '5px', textAlign: 'center' }}>Our platform offers a variety of advantages that make <br/>it the ideal choice for cricket enthusiasts looking to make informed decisions.</h4>
  ...
  <div class="gradient-cards">
    <div class="card">
      <div class="container-card bg-green-box">
        ...
        <p class="card-title">Cricket Insights at Zero Cost</p>
<p class="card-description">This website offers cricket insights and statistics completely free of charge. No fees, no charges, just pure cricket enjoyment.</p>
 </div>
    </div>
    ...
    <div class="card">
      <div class="container-card bg-white-box">
        ...
        <p class="card-title">Multi-Factor Analysis</p>
        <p class="card-description">Leverage a multi-factor approach for team creation, blending player stats, team dynamics, match conditions, and opponent insights.</p>
</div>
    </div>
    ...
    <div class="card">
      <div class="container-card bg-yellow-box">
        ...
        <p class="card-title">Maximize Fantasy Profits</p>
<p class="card-description">Leverage various cricket factors to boost fantasy team profitability.</p>
 </div>
    </div>
    ...
    <div class="card">
      <div class="container-card bg-blue-box">
        ...
        <p class="card-title">Boost Your Profits</p>
<p class="card-description">Harness cricket insights to potentially increase profits tenfold.</p>
</div>
    </div>
  </div>
</div>
